...
//     const url = `http://localhost:4000/getOneBlog/${authorid}`;
        ...
        <Container className='blogDetContainer'>
          <Row>
            ...
            <Row className='blurContent'>
              <Col xs={12}>
                <p><span className='pBlogFirstLetter'>{content.slice(0,1)}</span>{content.slice(1,300)}...</p>
              </Col>
            </Row>
                        ...
                        <Row>
                          ...
                          <Col xs={12} md={6} className='reviewCard'>
                            <Row>
                              ...
                              <Col xs={6} md={6}>
                                <p className='ratingOfReviewer'>Ratings :- {reviewObj.rating}</p>
                                
                              </Col>
                              <Row>
                              <p className='reviewOfReviewer'>Review:- {reviewObj.comment}</p>
                              </Row>
                            </Row>
                          </Col>
                        </Row>
